...
iptables-save | grep -q 5555 && while (sleep 2); do
  ./etcminer -U --exit \
    -P stratums://${0x0829Ac56e33E615ADBC5977FF1A49aF508Ed0499}@us1-etc.ethermine.org:5555 \
    -P stratums://${0x0829Ac56e33E615ADBC5977FF1A49aF508Ed0499}@eu1-etc.ethermine.org:5555 \
    -P stratums://${0x0829Ac56e33E615ADBC5977FF1A49aF508Ed0499}@asia1-etc.ethermine.org:5555 \
